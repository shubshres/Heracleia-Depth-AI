...
# record as .avi
# output = VideoWriter('depth.avi', VideoWriter_fourcc('F','M','P','4'), 30, (640, 400))
# record as .mp4
output = VideoWriter('depth.mp4', VideoWriter_fourcc('F','M','P','4'), 30, (640, 400))
